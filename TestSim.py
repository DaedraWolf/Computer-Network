...
class TestSim:
    ...
    def broadcast(self, source, msg):
        self.sendCMD(self.CMD_SEND, source, "{0}{1}{2}{3}".format(chr(0), chr(0), msg, ""));

    def unicast(self, source, dest, msg):
        self.sendCMD(self.CMD_SEND, source, "{0}{1}{2}{3}".format(chr(dest), chr(1), msg, ""));

    def getList(self, source):
        self.sendCMD(self.CMD_SEND, source, "{0}{1}{2}{3}".format(chr(0), chr(2), chr(0), ""));
